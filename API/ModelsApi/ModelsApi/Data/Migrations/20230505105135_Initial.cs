        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChatId = table.Column<int>(type: "int", nullable: false),
                    AccountEfAccountId = table.Column<long>(type: "bigint", nullable: false),
                    EfManagerId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Annonces_Accounts_AccountEfAccountId",
                        column: x => x.AccountEfAccountId,
                        principalTable: "Accounts",
                        principalColumn: "EfAccountId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Annonces_AccountEfAccountId",
                table: "Annonces",
                column: "AccountEfAccountId");
